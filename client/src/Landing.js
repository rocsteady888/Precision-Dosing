      ...
      <Grid container justify="center" spacing={24}>
        ...
        <Grid item xs={12} md={4}>
          <Card className={classes.card}>
            <img className={classes.media} src={infoCard1} alt="time-lapse" />
            <CardContent>
              <Typography gutterBottom variant="h5" component="h2">
                Mobile Friendly
              </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card className={classes.card}>
            <img className={classes.media} src={infoCard2} alt="time-lapse" />
            <CardContent>
              <Typography gutterBottom variant="h5" component="h2">
                Intuitive
              </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card className={classes.card}>
            <img className={classes.media} src={infoCard3} alt="time-lapse" />
            <CardContent>
              <Typography gutterBottom variant="h5" component="h2">
                Built Around You
              </Typography>
